...
# ---------------- GIF ----------------
EMBED_GIF = "https://cdn.discordapp.com/attachments/1413531402707800257/1413537770386882590/standard_2.gif?ex=68bc4b22&is=68baf9a2&hm=6c3ae6f8cb748bf05a0e8b96232b87bcd00313ac741f4b7cb029d98db0fcf854"
        ...
        try:
            async with ctx.typing():
                ...
                async with self.session.get(url, timeout=10) as response:
                    ...
                    embed.set_image(url="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExNmlqNTEzeWppcWI0aWszOHg5Mnp4c3ZkNTUybXVzbWtqYWdvaXB5YSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/0YSLjzYA6MJn9cNkEF/giphy.gif")
